...
class PlacidianSpeculum:
	'''Calculates Placidian(Ptolemy) Speculum for an object'''

	LON, LAT, RA, DECL, ADLAT, SA, MD, HD, TH, HOD, PMP, ADPH, POH, AODO = range(0, 14)


	def __init__(self, placelat, ramc, lon, lat, ra, decl):
		#transform
		#0-90: x = x
		...
		self.data = (lon, lat, ra, decl, adlat, sa, md, hd, th, hod, pmp, adphi, phi, ao)
